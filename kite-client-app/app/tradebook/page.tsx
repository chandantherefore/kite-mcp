    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">View all imported trades grouped by script with P&L analysis</p>
        </div>
        ...
        {loading && (
          <div className="flex items-center justify-center py-12 bg-white rounded-lg shadow">
            <div className="text-gray-600">Loading tradebook data...</div>
          </div>
        )}
        ...
        {!loading && data && data.groups.length === 0 && (
          <div className="text-center py-12 bg-white rounded-lg shadow">
            <p className="text-gray-600 mb-4">No trades found with the selected filters</p>
