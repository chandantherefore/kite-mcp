      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-white rounded-lg shadow p-6 border-l-4 border-red-500">
            ...
            <div className="text-xs text-gray-700 mt-1">Money Pumped In (Debit)</div>
          </div>

          <div className="bg-white rounded-lg shadow p-6 border-l-4 border-green-500">
            <div className="flex items-center justify-between mb-2">
              <div className="text-sm text-gray-700">Total Used</div>
          ...
          <div className="bg-white rounded-lg shadow p-6 border-l-4 border-blue-500">
            <div className="flex items-center justify-between mb-2">
              <div className="text-sm text-gray-700">Net Cash Balance</div>
          ...
          <div className="bg-white rounded-lg shadow p-6 border-l-4 border-purple-500">
            <div className="flex items-center justify-between mb-2">
              <div className="text-sm text-gray-700">Avaiable for Withdrawal</div>
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="mt-4 p-4 bg-purple-50 border border-purple-200 rounded-lg">
            <div className="text-sm font-medium text-purple-900 mb-2">Lost Funds Value Calculation:</div>
            <div className="text-sm text-purple-800 space-y-1">
              ...
              <div className="flex justify-between">
                <span>Book Voucher Differences (Head Purchases):</span>
                <span className="font-medium">-{formatCurrency(summary.categories.feesAndCharges.debit - summary.categories.feesAndCharges.credit)}</span>
              </div>
              <div className="flex justify-between">
                <span>Journal Entry (Zeroday payments):</span>
                <span className="font-medium">-{formatCurrency(summary.categories.internalAdjustment.debit - summary.categories.internalAdjustment.credit)}</span>
              </div>
              <div className="flex justify-between border-t border-purple-300 mt-2 pt-2 font-bold">
                <span>Lost Funds Value:</span>
                <span className="text-purple-900">{formatCurrency(
                  (summary.categories.fundsAdded.credit - summary.categories.fundsAdded.debit) - 
                  (summary.categories.fundsWithdrawn.debit - summary.categories.fundsWithdrawn.credit) - 
                  (summary.categories.feesAndCharges.debit - summary.categories.feesAndCharges.credit) - 
                  (summary.categories.internalAdjustment.debit - summary.categories.internalAdjustment.credit)
                )}</span>
              </div>
              <div className="text-xs text-purple-700 mt-2 italic">
                Formula: Bank Receipts (Debit) - Bank Payments (Credit) - Book Voucher (Debit-Credit) - Journal Entry (Debit-Credit)
              </div>
            </div>
          </div>
        </div>
