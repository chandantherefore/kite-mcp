    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 pb-8 border-b-4 border-green-200">
          ...
          {liveLoading ? (
            <div className="flex items-center justify-center py-12">
              <div className="text-gray-700">Loading live data...</div>
            </div>
          ) : hasLiveData ? (
            <>
            ...
            <div className="bg-white rounded-lg shadow p-8 text-center">
              <p className="text-gray-700 mb-4">No live trading data available</p>
        ...
        <div className="mb-8">
          ...
          {manualLoading ? (
            <div className="flex items-center justify-center py-12">
              <div className="text-gray-700">Loading manual portfolio data...</div>
            </div>
